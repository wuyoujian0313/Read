...
void safeVerifyPhoneCodeCFTimerCallback(CFRunLoopTimerRef timer, void *info) {
    // 剩余时间减1
    ForgetPwdVC *registerInfoVC = (__bridge id)info;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (row == curRow) {
        ...
        if (cell == nil) {
            ...
            UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(15 + 46 + 10, 0, tableView.frame.size.width - 105 - 15 - 46 - 10 - 15, 45)];
